	...
	<div class="container">
		...
		<nav id="nav-menu-container">
			<ul class="nav-menu">
				...
				<li><a href="#about-us">Search for Recipes</a></li>
...
============================-->
<footer class="footer">
	<div class="copyrights bootstrap_copyrights">
		<div class="container">
			<h4 style="color: red">Bootstrap template disclaimer:</h4>
...
<script src="static/lib/modal-video/js/modal-video.js"></script>
