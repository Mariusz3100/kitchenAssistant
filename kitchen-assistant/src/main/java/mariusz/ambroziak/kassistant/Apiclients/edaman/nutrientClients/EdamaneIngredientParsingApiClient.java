...
public class EdamaneIngredientParsingApiClient {
	public static final String baseUrl = "https://api.edamam.com/api/nutrition-details";
	...
	static String   fullBaseUrl="https://api.edamam.com/api/nutrition-details?app_id=47379841&app_key=d28718060b8adfd39783ead254df7f92";
			...
			for(int i=0;i<jsonIngredients.length();i++){
				...
				if(name.equals(Ingredientphrase)) {
					...
					for(int j=0;j<parsedIngredientsArrayJson.length();j++) {
						...
						String productPhrase = parsedJson.getString("food")+MetadataConstants.stringListSeparator+parsedJson.getString("foodMatch");
